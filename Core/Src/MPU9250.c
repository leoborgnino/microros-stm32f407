...
void writeAK8963Register(uint8_t subAddress, uint8_t data)
{
	...
	writeRegister(I2C_SLV1_ADDR,AK8963_I2C_ADDR);

	// set the register to the desired AK8963 sub address
	writeRegister(I2C_SLV1_REG,subAddress);

	// store the data for write
	writeRegister(I2C_SLV1_DO,data);

	// enable I2C and send 1 byte
	writeRegister(I2C_SLV1_CTRL,I2C_SLV0_EN | (uint8_t)1);
}
